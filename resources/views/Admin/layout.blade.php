        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('total/monthly') }}">
                            <i class="bi bi-circle"></i><span>Monthly sale</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('total/yearly') }}">
                            <i class="bi bi-circle"></i><span>Yearly sale</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('total/weekly') }}">
                            <i class="bi bi-circle"></i><span>Weekly sale</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Icons Nav -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('show-images') }}">
                    <i class="bi bi-person"></i>
                    <span>Slid Images</span>
                </a>
